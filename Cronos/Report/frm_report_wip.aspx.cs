...
{
    public partial class frm_report_wip : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (isValid)
                {
                    ...
                    {
                        TextObject TxtCompanyName = (TextObject)rd.ReportDefinition.Sections["Section1"].ReportObjects["TxtCompanyName"];
