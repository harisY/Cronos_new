...
namespace Cronos.Controllers
{
    ...
    {
        private Cronos.ApplicationUserManager _userManager;
        private Cronos.ApplicationRoleManager _roleManager;
        ...
        public Cronos.ApplicationUserManager UserManager
        {
            get
            {
                return _userManager ??
                    HttpContext.GetOwinContext()
                    .GetUserManager<Cronos.ApplicationUserManager>();
            }
            private set
            {
                _userManager = value;
        ...
        public Cronos.ApplicationRoleManager RoleManager
        {
            get
            {
                return _roleManager ??
                    HttpContext.GetOwinContext()
                    .GetUserManager<Cronos.ApplicationRoleManager>();
            }
            private set
            {
                _roleManager = value;
